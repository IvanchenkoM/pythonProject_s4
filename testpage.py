...
class OperationsHelper(BasePage):
    ...
    def enter_contact_name(self, word):
        self.enter_text_info_field(TestSearchLocators.ids['LOCATOR_CONTACT_NAME_FIELD'], word,
                                   description='contact name')

    def enter_contact_email(self, word):
        self.enter_text_info_field(TestSearchLocators.ids['LOCATOR_CONTACT_EMAIL_FIELD'], word,
...
def get_login():
    try:
        ...
        logging.error(f"Error in get_login(): {e}")
        return None
...
def get_post(token):
    try:
        ...
        logging.error(f"Error in get_post(): {e}")
        return None
...
def get_my_post(token):
    try:
        ...
        logging.error(f"Error in get_my_post(): {e}")
        return None
